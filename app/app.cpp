        ...
        "<body>\n"
         "<nav class="navbar navbar-inverse">"
          "<div class="container-fluid">"
            ...
            "</ul>"
            "<p class="navbar-text" style="font-family:Sans-serif;color:\x23ff0084"> CppCMS Lab v0.0.01</p>"
            "<p class="navbar-text" style="font-family:Sans-serif;float:right"> Horário UTC:  <span style="color:\x23ffffff"> <%= Date() %> </span></p>"
          "</div>"
        "</nav>"
        "  <h1>Hello World!!</h1>\n"
        "</body>\n"
